...
export const supabaseRepository: DataRepository = {
  ...
  listConversations: (...args) => localRepository.listConversations(...args),
  createConversation: (...args) => localRepository.createConversation(...args),
  setActiveConversation: (...args) => localRepository.setActiveConversation(...args),
  listMessages: (...args) => localRepository.listMessages(...args),
  appendMessages: (...args) => localRepository.appendMessages(...args),
  updateMessage: (...args) => localRepository.updateMessage(...args),
